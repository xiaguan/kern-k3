...
// keep busy.
//
//   nvcc -cubin -arch=sm_103a -o k3_residual_push.cubin k3_residual_push.cu
...
#pragma unroll
    ...
    /* the peers read these stores over NVLink once the barrier of the next call
     * passes, so they have to be system-visible before this kernel retires */
